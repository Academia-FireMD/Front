...
async function main() {
  ...
  // ALUMNO: planificación mensual sin fallback
  ...
  await page.screenshot({ path: path.join(OUT_DIR, '26-alumno-temario-sin-fallback.png'), fullPage: true });

  await browser.close();
  console.log('Captura sin fallback completada.');
}
